...
public class Welcome02_Object {
   public static void main(String[] args) {
      ...
      // Location 3 (replace with YOUR location from the previous question)
      String id3 = "KEKY"; // <-- change this if needed
      DataSource ds3 = DataSource.connect(
            "http://weather.gov/xml/current_obs/" + id3 + ".xml");
      ...
      // Determine the coldest location
      String coldestId = id1;
      ...
      System.out.println("Coldest location is " + coldestId);
   }
}
